...
public class Series {
    ...
    public static double distance
        ...
        double dx = x2 - x1;
        double dy = y2 - y1;
        System.out.println("dx wynosi " + dx);
        System.out.println("dy wynosi " + dy);
        return 0.0;
    }
    ...
    public static double distance2
        ...
        System.out.println("Wartość dsquared to " + dsquared);
        return 0.0;
    }
     ...
     * @return true, jeśli x jest liczbą jednocyfrową, false w przeciwnym przypadku
     */
